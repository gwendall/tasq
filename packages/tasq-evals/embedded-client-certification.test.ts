  ...
  test("binds the accepted package seam and explicit composition interface", () => {
    expect(certificate).toMatchObject({
      ...
      publication: {
        ...
        releaseWorkflow: "https://github.com/gwendall/tasq/actions/runs/30050429924",
        postReleaseCertification: "https://github.com/gwendall/tasq/actions/runs/30051196124",
