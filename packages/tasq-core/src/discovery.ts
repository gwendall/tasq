...
const KERNEL_CAPABILITIES: readonly CapabilityDefinition[] = [
  ...
  { name: "completion-resolution", operations: {
    create_contract: "createResolutionContract",
    get_contract: "getResolutionContract",
    list_contracts: "listResolutionContracts",
    attest_evidence_trust: "attestEvidenceTrust",
    revoke_evidence_trust: "revokeEvidenceTrust",
    get_evidence_trust: "getEvidenceTrustRecord",
    list_evidence_trust: "listEvidenceTrustRecords",
    propose: "proposeCompletion",
    get_proposal: "getCompletionProposal",
    list_proposals: "listCompletionProposals",
    challenge: "challengeCompletion",
    get_challenge: "getCompletionChallenge",
    list_challenges: "listCompletionChallenges",
    evaluate_deterministically: "evaluateCompletionDeterministically",
    attest: "attestCompletion",
    settle_optimistic: "settleOptimisticCompletion",
    adjudicate: "adjudicateCompletion",
    get_decision: "getValidationDecision",
