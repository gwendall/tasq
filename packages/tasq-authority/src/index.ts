...
const rawActions = [
  ...
  ["resolution.trust", ["commitment"], "none", "none"],
  ["resolution.propose", ["commitment"], "none", "none"],
  ["resolution.decide", ["commitment"], "none", "none"],
  ["credential.manage", ["workspace"], "required", "none"],
  ["statement.accept", ["workspace"], "none", "none"],
