#!/bin/sh
# Tasq Local v0.6.5 verified lifecycle bootstrap.
#
# Inspect first:
...
usage() {
  cat <<'EOF'
Usage: install.sh [--version 0.6.5] [--prefix PATH] [--dry-run]
                  [--activate|--uninstall]
...
[ "$VERSION" = "0.6.5" ] || fail "this versioned bootstrap supports only Tasq 0.6.5"
[ -n "$PREFIX" ] || fail "--prefix must not be empty"

case "$(uname -s):$(uname -m)" in
  Darwin:arm64)
    TARGET="darwin-arm64"
    CHECKSUMS_SHA256="673d4d51b24abe4d3a1f28ae07d46842d10c79bf1b9e3b56327e26f447cd3946"
    ;;
  Linux:x86_64)
    TARGET="linux-x64-gnu"
    CHECKSUMS_SHA256="d94e89bf5b70ed84442ee95243bacd50abe07a5f52b9df0c8af37fefa5fe6206"
    ;;
  *)
