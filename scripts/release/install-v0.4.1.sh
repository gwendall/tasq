#!/bin/sh
# Tasq Local v0.4.1 verified lifecycle bootstrap.
#
# Inspect first:
...
#
# Install:
#   sh /tmp/tasq-install.sh --version 0.4.1 --prefix "$HOME/.local"
...
usage() {
  cat <<'EOF'
Usage: install.sh [--version 0.4.1] [--prefix PATH] [--dry-run]
                  [--activate|--uninstall]
...
[ "$VERSION" = "0.4.1" ] || fail "this versioned bootstrap supports only Tasq 0.4.1"
[ -n "$PREFIX" ] || fail "--prefix must not be empty"

case "$(uname -s):$(uname -m)" in
  Darwin:arm64)
    TARGET="darwin-arm64"
    CHECKSUMS_SHA256="d55a157248db7bb70bd166c57e15abc7761b475b5777aadda3aa8d91ce5e554a"
    ;;
  Linux:x86_64)
    TARGET="linux-x64-gnu"
    CHECKSUMS_SHA256="1d929f2ba8af9111ff1611844db917bebe971ec06d00c2ed002b92e06f6b0987"
    ;;
  *)
