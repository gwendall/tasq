#!/bin/sh
# Tasq Local v0.1.1 verified lifecycle bootstrap.
#
# Inspect first:
...
usage() {
  cat <<'EOF'
Usage: install.sh [--version 0.1.1] [--prefix PATH] [--dry-run]
                  [--activate|--uninstall]
...
[ "$VERSION" = "0.1.1" ] || fail "this versioned bootstrap supports only Tasq 0.1.1"
[ -n "$PREFIX" ] || fail "--prefix must not be empty"

case "$(uname -s):$(uname -m)" in
  Darwin:arm64)
    TARGET="darwin-arm64"
    CHECKSUMS_SHA256="153559265b9ec788cb5be8c94c267006c525090fcc268df2c00fd38ba26a2637"
    ;;
  Linux:x86_64)
    TARGET="linux-x64-gnu"
    CHECKSUMS_SHA256="257ea51b3f22c42166bb84fe36aebfdd5bf3ef8bafc5798a3c12f178ecb4415f"
    ;;
  *)
