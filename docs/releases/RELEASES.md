...
the same fail-closed handoff. Current `v0.6.8` is published, carrying the seven packages that changed;
...
## `v0.6.8` current release

Published 2026-09-10T22:40:54Z from tag `v0.6.8`, protected run
[34536831374](https://github.com/gwendall/tasq/actions/runs/34536831374).
Certified by [34538672213](https://github.com/gwendall/tasq/actions/runs/34538672213).
...
Published 2026-09-10T20:09:08Z from tag `v0.6.7`, protected run
[34522233347](https://github.com/gwendall/tasq/actions/runs/34522233347).
Certified by [34524668924](https://github.com/gwendall/tasq/actions/runs/34524668924).
Surfaces recorded: serverImage, pythonWheel, remoteTypeScriptClient.
...
Published 2026-09-10T17:30:47Z from tag `v0.6.6`, protected run
[34507952784](https://github.com/gwendall/tasq/actions/runs/34507952784).
Certified by [34508717494](https://github.com/gwendall/tasq/actions/runs/34508717494).
Surfaces recorded: serverImage, pythonWheel, remoteTypeScriptClient.
...
Certified by [34046425533](https://github.com/gwendall/tasq/actions/runs/34046425533).
Surfaces recorded: pythonWheel, remoteTypeScriptClient.
...
Published 2026-09-06T08:52:19Z from tag `v0.6.2`, protected run
[34022726384](https://github.com/gwendall/tasq/actions/runs/34022726384).

A patch at store format 35 carrying the root-cause fixes behind the 2026-09-02
loss of this project's own directory binding: the global default that setup
rewrote, config writes that dropped bindings, drift between AGENTS.md and the
private binding, a projection rendered into another space's file, and a
personal name as the implicit workspace.
