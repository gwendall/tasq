...
- [`RELEASES.md`](RELEASES.md) - release channels and operator expectations.
- [`OPEN_SOURCE_PRODUCTIZATION_SPEC.md`](OPEN_SOURCE_PRODUCTIZATION_SPEC.md) - package and lifecycle gates.
- [`PUBLIC_RELEASE_POLICY.json`](PUBLIC_RELEASE_POLICY.json) - machine-readable
