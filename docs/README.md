...
| Evaluate managed Cloud source | [Experimental composition decision](decisions/ADR-019_EXPERIMENTAL_CLOUD_COMPOSITION.md) → [Cloud control plane](contracts/TQ-901_MANAGED_CLOUD_CONTROL_PLANE.md) → [hostile proof](contracts/TQ-905_MANAGED_CLOUD_HOSTILE_CERTIFICATION.md) → [remote-effects gate](contracts/TQ-906_REMOTE_EFFECTS_REVIEW_GATE.md) |
