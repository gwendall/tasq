...
> `../decisions/ADR-UK-EXT_EXTENSION_REGISTRY.md` defines durable identity and trust;
...
See `../contracts/TQ-305_CONNECTOR_CONFORMANCE.md` for the complete behavioral matrix,
