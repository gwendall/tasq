#!/bin/sh
# Tasq Local v0.6.2 verified lifecycle bootstrap.
#
# Inspect first:
...
usage() {
  cat <<'EOF'
Usage: install.sh [--version 0.6.2] [--prefix PATH] [--dry-run]
                  [--activate|--uninstall]
...
[ "$VERSION" = "0.6.2" ] || fail "this versioned bootstrap supports only Tasq 0.6.2"
[ -n "$PREFIX" ] || fail "--prefix must not be empty"

case "$(uname -s):$(uname -m)" in
  Darwin:arm64)
    TARGET="darwin-arm64"
    CHECKSUMS_SHA256="cb87ac0bf52a0c24c8865b2a5b0f2b8e2d0e649b6740e30a50e0f3ca3dd84fa7"
    ;;
  Linux:x86_64)
    TARGET="linux-x64-gnu"
    CHECKSUMS_SHA256="baac31ff57c2c6c0aebe8b6183b01411fc2e83d075918f544e45eed653fa3ed8"
    ;;
  *)
