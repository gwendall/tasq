#!/bin/sh
# Tasq Local v0.2.0 verified lifecycle bootstrap.
#
# Inspect first:
...
usage() {
  cat <<'EOF'
Usage: install.sh [--version 0.2.0] [--prefix PATH] [--dry-run]
                  [--activate|--uninstall]
...
[ "$VERSION" = "0.2.0" ] || fail "this versioned bootstrap supports only Tasq 0.2.0"
[ -n "$PREFIX" ] || fail "--prefix must not be empty"

case "$(uname -s):$(uname -m)" in
  Darwin:arm64)
    TARGET="darwin-arm64"
    CHECKSUMS_SHA256="5790eb9f77eddb35668043d7f8b89f29367ac26b8c0747ba10072f190d94dd4c"
    ;;
  Linux:x86_64)
    TARGET="linux-x64-gnu"
    CHECKSUMS_SHA256="625f665be5c1d329368b0e9ab1381c7149b1cee37b7420f7f788add3d926288c"
    ;;
  *)
